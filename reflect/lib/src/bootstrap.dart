...
/// Detects root [Controller]s and add them to provided [server]
///
/// If provided, [injector] is used as DI to instantiate the [Controller] classes
...
class _Scanner {
  ...
  bool _isApi(InstanceMirror im) => im.reflectee is Controller;
